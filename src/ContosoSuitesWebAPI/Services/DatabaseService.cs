...
public class DatabaseService(string connectionString) : IDatabaseService
{
    ...
    /// </summary>
    [KernelFunction]
    [Description("Get hotel books after a specified date.")]
    public async Task<IEnumerable<Booking>> GetBookingsByHotelAndMinimumDate(
        [Description("The ID of the hotel and date")] int hotelId, DateTime dt)
    {
    ...
    [KernelFunction]
    [Description("Get bookings without rooms")]
    ...
    [KernelFunction]
    [Description("Get bookings with multiple rooms.")]
